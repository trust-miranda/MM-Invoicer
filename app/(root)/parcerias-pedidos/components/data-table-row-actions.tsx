    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[160px]">
        ...
        <DropdownMenuSub>
          ...
          <DropdownMenuSubContent>
            <DropdownMenuRadioGroup value={task["Estado do Pedido"]}>
              {statuses.map((label) => (
        ...
        <DropdownMenuSeparator />
        <DropdownMenuSub>
          <DropdownMenuSubTrigger>Nível de Urgência</DropdownMenuSubTrigger>
          <DropdownMenuSubContent>
            <DropdownMenuRadioGroup value={task["Nível de Urgência"]}>
